	...
	public function customize_checkout_fields_per_product_type( $fields ) {
		...
		if ( b4b_have_event_in_cart( "event_scramble" ) ) {
			$fields["b4b_scramble_team"] = [
				"b4b_scramble_team_members[2][name]"        => [
					"type"  => "text",
					"label" => __( "Team Member 2 Full Name", B4B_TEXT_DOMAIN ),
				],
				"b4b_scramble_team_members[2][tshirt_size]" => [
					"type"    => "select",
					"label"   => __( "Team Member 2 T-Shirt Size", B4B_TEXT_DOMAIN ),
					"options" => b4b_tshirt_sizes(),
				],
				"b4b_scramble_team_members[2][hat_size]"    => [
					"type"    => "select",
					"label"   => __( "Team Member 2 Hat Size", B4B_TEXT_DOMAIN ),
					"options" => b4b_hat_sizes(),
				],
				"b4b_scramble_team_members[3][name]"        => [
					"type"  => "text",
					"label" => __( "Team Member 3 Full Name", B4B_TEXT_DOMAIN ),
				],
				"b4b_scramble_team_members[3][tshirt_size]" => [
					"type"    => "select",
					"label"   => __( "Team Member 3 T-Shirt Size", B4B_TEXT_DOMAIN ),
					"options" => b4b_tshirt_sizes(),
				],
				"b4b_scramble_team_members[3][hat_size]"    => [
					"type"    => "select",
					"label"   => __( "Team Member 3 Hat Size", B4B_TEXT_DOMAIN ),
					"options" => b4b_hat_sizes(),
				],
				"b4b_scramble_team_members[4][name]"        => [
					"type"  => "text",
					"label" => __( "Team Member 4 Full Name", B4B_TEXT_DOMAIN ),
				],
				"b4b_scramble_team_members[4][tshirt_size]" => [
					"type"    => "select",
					"label"   => __( "Team Member 4 T-Shirt Size", B4B_TEXT_DOMAIN ),
					"options" => b4b_tshirt_sizes(),
				],
				"b4b_scramble_team_members[4][hat_size]"    => [
					"type"    => "select",
					"label"   => __( "Team Member 4 Hat Size", B4B_TEXT_DOMAIN ),
					"options" => b4b_hat_sizes(),
				],
			];
		}
	...
	public function account_dashboard_show_donation_list() {
		...
		if ( $adp ) {
			...
			if ( is_user_logged_in() === true ) {
				...
				$donation_link .= "?for=" . get_current_user_id();
			}
